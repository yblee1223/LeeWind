...
import Quartz  # macOS에서 스크린 관련 기능을 위한 모듈
...
# 스크린샷 저장 폴더 설정
save_folder = "/Users/apple/Desktop/Python/Smarcle/PythonWeek/NotionVersion/screenshots"
os.makedirs(save_folder, exist_ok=True)  # 폴더가 없으면 생성

# 텍스트 저장 폴더 설정
text_save_folder = "/Users/apple/Desktop/Python/Smarcle/PythonWeek/NotionVersion/texts"
os.makedirs(text_save_folder, exist_ok=True)  # 폴더가 없으면 생성

# OCR 결과 저장 폴더 설정
ocr_json_folder = "/Users/apple/Desktop/Python/Smarcle/PythonWeek/NotionVersion/json"
os.makedirs(ocr_json_folder, exist_ok=True)  # 폴더가 없으면 생성
